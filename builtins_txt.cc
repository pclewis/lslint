...
"const integer CHANGED_REGION_START = CHANGED_REGION_START",
...
"const integer PSYS_SRC_OBJ_REL_MASK = LLPartSysData::LL_PART_SRC_OBJ_REL_MASK",
"const integer PRIM_CAST_SHADOWS = LSL_PRIM_CAST_SHADOWS",
"const integer PRIM_TEXT = LSL_PRIM_TEXT",
"const integer PRIM_NAME = LSL_PRIM_NAME",
"const integer PRIM_DESC = LSL_PRIM_DESC",
"const integer PRIM_SCULPT_TYPE_MASK = LSL_PRIM_SCULPT_TYPE_MASK",
"const integer PARCEL_MEDIA_COMMAND_TYPE = PARCEL_MEDIA_COMMAND_TYPE",
"const integer PARCEL_MEDIA_COMMAND_SIZE = PARCEL_MEDIA_COMMAND_SIZE",
"const integer PARCEL_MEDIA_COMMAND_DESC = PARCEL_MEDIA_COMMAND_DESC",
"const integer PARCEL_MEDIA_COMMAND_LOOP_SET = PARCEL_MEDIA_COMMAND_LOOP_SET",
"const integer PARCEL_FLAG_ALLOW_GROUP_SCRIPTS = PF_ALLOW_GROUP_SCRIPTS",
"const integer PARCEL_FLAG_ALLOW_GROUP_OBJECT_ENTRY = PF_ALLOW_GROUP_OBJECT_ENTRY",
"const integer PARCEL_FLAG_ALLOW_ALL_OBJECT_ENTRY = PF_ALLOW_ALL_OBJECT_ENTRY",
"const integer PARCEL_DETAILS_ID = PARCEL_DETAILS_ID",
"const integer CLICK_ACTION_NONE = CLICK_ACTION_NONE",
"const integer CLICK_ACTION_TOUCH = CLICK_ACTION_TOUCH",
"const integer CLICK_ACTION_SIT = CLICK_ACTION_SIT",
"const integer CLICK_ACTION_BUY = CLICK_ACTION_BUY",
"const integer CLICK_ACTION_PAY = CLICK_ACTION_PAY",
"const integer CLICK_ACTION_OPEN = CLICK_ACTION_OPEN",
"const integer CLICK_ACTION_PLAY = CLICK_ACTION_PLAY",
"const integer CLICK_ACTION_OPEN_MEDIA = CLICK_ACTION_OPEN_MEDIA",
